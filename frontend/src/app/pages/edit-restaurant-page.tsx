...
export function EditRestaurantPage() {
  ...
  const { restaurants, updateRestaurant } = useVenue();
  ...
  useEffect(() => {
    if (restaurant) {
      ...
      setSanitationGrade(restaurant.sanitationGrade);
      setPhoneNumber(restaurant.phoneNumber);
      setEmail(restaurant.email);
      setSeatingCapacity(restaurant.seatingCapacity.toString());
      setGroupSeating(restaurant.groupSeating);
      setStudentDiscount(restaurant.studentDiscount);
      setDiscountDetails(restaurant.discountDetails || '');
      setSelectedDietaryOptions(restaurant.dietaryOptions);
    }
  }, [restaurant]);
        ...
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Update your restaurant listing
            </p>
          </div>
        </div>
      </header>
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="bg-gradient-to-r from-purple-500/90 to-pink-500/90 text-white rounded-t-xl pb-6">
            ...
            <CardDescription className="text-purple-50 pt-1">
              Update the information about your restaurant
            </CardDescription>
          </CardHeader>
